...
//                         if(msg.Length > 1400  || !Regex.IsMatch(msg, baseRegex) || !Regex.IsMatch(displayname, baseRegex) || displayname.Length > 20)
//                         {
//                             ++messageID;
//                             Console.Error.WriteLine("ERR: Message too long. Max length is 1400 characters.");
//                             byte[] errorMessage = UDPmessageHelper.buildErrorMessage(messageID, "Message too long. Max length is 1400 characters.", displayName, MessageType.ERR);    
